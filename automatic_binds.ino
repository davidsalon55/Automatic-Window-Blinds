...
#define TEMP_LOWER_LIMIT 29

#define LDR_RIGHT_LIMIT 89
#define LDR_LEFT_LIMIT 78

#define MOTOR_LEFT_CLOSE_DURATION 2100
...
int LDRRight() {
  ...
  return constrain(map(analogRead(LDR_RIGHT_PIN), 500, 0, 0, 100), 0, 100);
}

int LDRLeft() {
    // return analogRead(LDR_LEFT_PIN);
  return constrain(map(analogRead(LDR_LEFT_PIN), 800, 0, 0, 100), 0, 100);
}
